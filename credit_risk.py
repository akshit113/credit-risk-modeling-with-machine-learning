...
epochs = 2
batch = 2048
test_acc, test_loss = fit_and_evaluate(classifier, x_train, y_train, x_test, y_test, batch_size=batch, epochs=epochs)
...
y_hat, y = make_predictions(classifier, x_test, y_test)
print(y_hat)
